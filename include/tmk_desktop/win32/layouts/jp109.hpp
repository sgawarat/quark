...
namespace tmk_desktop::inline win32::jp109 {
...
constexpr uint16_t to_keycode(Key key) noexcept {
  switch (key) {
#define M(name, keycode, value) \
  case K_##name: \
    return KC_##name;
