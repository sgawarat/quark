...
#define LAYOUT( \
  ...
  ESCAPE, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, PRINT_SCREEN, SCROLL_LOCK, PAUSE, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
  HANKAKU_ZENKAKU, _1, _2, _3, _4, _5, _6, _7, _8, _9, _0, MINUS, CIRCUMFLEX, YEN, BACKSPACE, INSERT, HOME, PAGE_UP, NUM_LOCK, KP_SLASH, KP_ASTERISK, KP_MINUS, \
  TAB, Q, W, E, R, T, Y, U, I, O, P, AT, LEFT_BRACKET, DELETE, END, PAGE_DOWN, KP_7, KP_8, KP_9, KC_NO, KC_NO, KC_NO, \
  CAPS_LOCK, A, S, D, F, G, H, J, K, L, SEMICOLON, COLON, RIGHT_BRACKET, ENTER, KP_4, KP_5, KP_6, KP_PLUS, KC_NO,  KC_NO, KC_NO, KC_NO, \
