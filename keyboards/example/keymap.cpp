...
constexpr action_t AC_RIGHT_DOUBLE_ARROW = ACTION_MACRO(M_RIGHT_DOUBLE_ARROW);
...
action_t action_for_key(uint8_t layer, keypos_t pos) {
  ...
  static constexpr std::array LTHUMB_ACTIONMAP{  // WIP
    ...
    AC_LBRACKET, AC_ASTERISK, AC_LBRACE, AC_LPAREN, AC_HASH, AC_DOLLAR, AC_RPAREN, AC_RBRACE, AC_AMPERSAND, AC_RBRACKET, AC_RIGHT_DOUBLE_ARROW, AC_NO,
